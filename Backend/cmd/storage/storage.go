...
type Storage interface {
	...
	GetFiles() ([]*types.File, error)
	GetFileById(file_id int64) (*types.File, error)
	DeleteFileById(file_id int64) error
	GetFilesOfAccount(id int64) ([]*types.File, error)
	GetRandomFile(account_id int64) (*types.File, error)
	GetStatOfFile(fileId int64) (*types.FileStat, error)
	RateFile(req *types.FileStat) error
	GetRatedFiles() ([]*types.FileStat, error)
	AddFileToDB(int64, *types.File) error
}
...
func (s *PostgresStore) GetAccountByName(name string) (*types.Account, error) {
...
func (s *PostgresStore) GetAccountByID(id int64) (*types.Account, error) {
...
func (s *PostgresStore) GetStatOfFile(id int64) (*types.FileStat, error) {
	rows, err := s.db.Query(`
...
func (s *PostgresStore) AddFileToDB(accountID int64, f *types.File) error {
	tx, err := s.db.Begin()
	if err != nil {
...
func (s *PostgresStore) GetFiles() ([]*types.File, error) {
...
func (s *PostgresStore) GetFilesOfAccount(id int64) ([]*types.File, error) {
...
func (s *PostgresStore) GetFileById(id int64) (*types.File, error) {
...
func (s *PostgresStore) GetRandomFile(account_id int64) (*types.File, error) {
...
func (s *PostgresStore) RateFile(req *types.FileStat) error {
	query := (`
...
func (s *PostgresStore) GetRatedFiles() ([]*types.FileStat, error) {
	rows, err := s.db.Query(`
...
func ScanIntoFile(rows *sql.Rows) (*types.File, error) {
	file := new(types.File)
	err := rows.Scan(
		&file.ID,
		&file.Name,
...
func ScanIntoAccountFile(rows *sql.Rows) (*types.FileStat, error) {
	account_file := new(types.FileStat)
	err := rows.Scan(
